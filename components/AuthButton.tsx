...
export default function AuthButton() {
  ...
  return (
    <button
      onClick={handleLogin}
      className="flex items-center gap-2 px-3 sm:px-5 py-2 sm:py-2.5 bg-white border-2 border-[var(--border)] rounded-2xl text-[10px] sm:text-sm font-black text-[var(--foreground)] hover:border-[var(--primary)] hover:bg-blue-50 transition-all shadow-sm active:scale-95 whitespace-nowrap"
    >
      ...
      <span className="hidden sm:inline">Google로 시작하기</span>
